 ...
 */
export var addPart = function addPart(parent) {
...
export var addDigit = function addDigit(parent, type, isHigh) {
...
export var addDigitsBlock = function addDigitsBlock(parent, type) {
  if (!parent || !type) return null; //
...
export var addColumnBlock = function addColumnBlock(parent) {
  if (!parent) return null; //
...
export var addDot = function addDot(parent, isTop) {
  if (!parent) return null; //
